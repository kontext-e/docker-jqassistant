...
LABEL version="1.5.1"
LABEL description="jQAssistant 1.5.0 with Kontext E Plugin suite 1.5.1"

ARG KE_PLUGIN_VERSION="1.5.1"
ARG KE_PLUGINS="pmd plantuml plaintext linecount javaparser jacoco git findbugs checkstyle asciidoc"

RUN apk add --no-cache wget unzip \
 && wget https://jqassistant.org/wp-content/uploads/2018/10/jqassistant-commandline-neo4jv3-1.5.0-distribution.zip -O jqassistant.zip \
 ...
 && wget https://search.maven.org/remotecontent?filepath=net/sourceforge/plantuml/plantuml/1.2018.11/plantuml-1.2018.11.jar -O jqassistant/plugins/plantuml-1.2018.11.jar
